...
The MySQL database stores structured operational game data including:

- Players and player profiles

- Player MMR and ranking system

- Matches and match metadata

- Match player performance statistics

- Weapons and loadout configurations
...
This repository contains all database related deliverables for the Game Matchmaking System including:

- MySQL database schema definitions

- SQL scripts for table creation and relationships

- Stored procedures and supporting SQL logic
